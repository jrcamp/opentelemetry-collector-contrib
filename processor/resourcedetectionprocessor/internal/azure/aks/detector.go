...
func (detector *Detector) Detect(ctx context.Context) (pdata.Resource, error) {
	...
	attr := res.Attributes()
	attr.InsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAzure)
	attr.InsertString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformAzureAKS)
