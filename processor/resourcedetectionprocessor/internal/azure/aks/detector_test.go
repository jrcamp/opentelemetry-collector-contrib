...
// Tests AKS resource detector running in AKS environment
func TestAKS(t *testing.T) {
	ctx := context.Background()

	require.NoError(t, os.Setenv("KUBERNETES_SERVICE_HOST", "localhost"))

	// Call AKS Resource detector to detect resources
	aksResourceDetector := &Detector{}
	res, err := aksResourceDetector.Detect(ctx)
...
// Tests AKS resource detector not running in AKS environment
